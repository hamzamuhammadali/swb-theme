...
class CreditNoteApi
{
     ...
     *
     * @param  \Swagger\Client\Model\FactoryCreateFromInvoiceBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse201
     */
    public function createCreditNoteFromInvoice($body = null)
    {
        list($response) = $this->createCreditNoteFromInvoiceWithHttpInfo($body);
        return $response;
    }
     ...
     * Creates a new creditNote from an invoice
     *
     * @param  \Swagger\Client\Model\FactoryCreateFromInvoiceBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCreditNoteFromInvoiceWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->createCreditNoteFromInvoiceRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditNoteFromInvoiceAsync($body = null)
    {
        return $this->createCreditNoteFromInvoiceAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditNoteFromInvoiceAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->createCreditNoteFromInvoiceRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCreditNoteFromInvoiceRequest($body = null)
    {
     ...
     *
     * @param  \Swagger\Client\Model\FactoryCreateFromVoucherBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse201
     */
    public function createCreditNoteFromVoucher($body = null)
    {
        list($response) = $this->createCreditNoteFromVoucherWithHttpInfo($body);
        return $response;
    }
     ...
     * Creates a new creditNote from a voucher
     *
     * @param  \Swagger\Client\Model\FactoryCreateFromVoucherBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCreditNoteFromVoucherWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->createCreditNoteFromVoucherRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditNoteFromVoucherAsync($body = null)
    {
        return $this->createCreditNoteFromVoucherAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditNoteFromVoucherAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->createCreditNoteFromVoucherRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCreditNoteFromVoucherRequest($body = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelCreditNoteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function creditNoteSendByWithHttpInfo($credit_note_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelCreditNoteResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelCreditNoteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ModelCreditNoteSendByWithRender
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelCreditNoteSendByWithRender, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendCreditNoteByPrintingWithHttpInfo($credit_note_id, $send_type)
    {
        $returnType = '\Swagger\Client\Model\ModelCreditNoteSendByWithRender';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelCreditNoteSendByWithRender',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
