...
class VoucherApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelVoucherResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVoucherWithHttpInfo($voucher_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelVoucherResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
