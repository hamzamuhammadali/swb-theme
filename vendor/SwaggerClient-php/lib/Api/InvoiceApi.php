...
class InvoiceApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelInvoiceWithHttpInfo($invoice_id)
    {
        $returnType = '\Swagger\Client\Model\ModelInvoiceResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelInvoiceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \Swagger\Client\Model\ModelInvoiceResponse
     */
    public function createInvoiceFromOrder($body = null)
    {
     ...
     * @return array of \Swagger\Client\Model\ModelInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInvoiceFromOrderWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelInvoiceResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInvoiceFromOrderAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInvoiceFromOrderAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelInvoiceResponse';
        $request = $this->createInvoiceFromOrderRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createInvoiceFromOrderRequest($body = null)
    {
