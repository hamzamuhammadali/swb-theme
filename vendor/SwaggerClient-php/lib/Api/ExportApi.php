...
class ExportApi
{
     ...
     * @param  \Swagger\Client\Model\SevClientIdUpdateExportConfigBody $body Specify the update (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse20020
     */
    public function updateExportConfig($sev_client_id, $body = null)
    {
        list($response) = $this->updateExportConfigWithHttpInfo($sev_client_id, $body);
        return $response;
    }
     ...
     */
    public function updateExportConfigWithHttpInfo($sev_client_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20020';
        $request = $this->updateExportConfigRequest($sev_client_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateExportConfigAsync($sev_client_id, $body = null)
    {
        return $this->updateExportConfigAsyncWithHttpInfo($sev_client_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateExportConfigAsyncWithHttpInfo($sev_client_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20020';
        $request = $this->updateExportConfigRequest($sev_client_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateExportConfigRequest($sev_client_id, $body = null)
    {
