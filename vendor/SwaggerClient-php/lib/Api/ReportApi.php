...
class ReportApi
{
     ...
     * Export invoice list
     *
     * @param  string $view view (required)
     ...
     */
    public function reportInvoice($view, $sev_query, $download = null)
    {
        list($response) = $this->reportInvoiceWithHttpInfo($view, $sev_query, $download);
        return $response;
    }
     ...
     */
    public function reportInvoiceWithHttpInfo($view, $sev_query, $download = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20043';
        $request = $this->reportInvoiceRequest($view, $sev_query, $download);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportInvoiceAsync($view, $sev_query, $download = null)
    {
        return $this->reportInvoiceAsyncWithHttpInfo($view, $sev_query, $download)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportInvoiceAsyncWithHttpInfo($view, $sev_query, $download = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20043';
        $request = $this->reportInvoiceRequest($view, $sev_query, $download);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function reportInvoiceRequest($view, $sev_query, $download = null)
    {
        // verify the required parameter 'view' is set
        if ($view === null || (is_array($view) && count($view) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $view when calling reportInvoice'
            );
        }
        // verify the required parameter 'sev_query' is set
        if ($sev_query === null || (is_array($sev_query) && count($sev_query) === 0)) {
     ...
     */
    public function reportOrder($view, $sev_query, $download = null)
    {
        list($response) = $this->reportOrderWithHttpInfo($view, $sev_query, $download);
        return $response;
    }
     ...
     */
    public function reportOrderWithHttpInfo($view, $sev_query, $download = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20044';
        $request = $this->reportOrderRequest($view, $sev_query, $download);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportOrderAsync($view, $sev_query, $download = null)
    {
        return $this->reportOrderAsyncWithHttpInfo($view, $sev_query, $download)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportOrderAsyncWithHttpInfo($view, $sev_query, $download = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20044';
        $request = $this->reportOrderRequest($view, $sev_query, $download);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function reportOrderRequest($view, $sev_query, $download = null)
    {
        // verify the required parameter 'view' is set
        if ($view === null || (is_array($view) && count($view) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $view when calling reportOrder'
            );
        }
        // verify the required parameter 'sev_query' is set
        if ($sev_query === null || (is_array($sev_query) && count($sev_query) === 0)) {
