...
class OrderPosApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelOrderPosResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderPositionWithHttpInfo($order_pos_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelOrderPosResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelOrderPosResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
