...
class ContactApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelContactResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelContactResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelContactResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function findContactsByCustomFieldValue($value, $custom_field_name, $custom_field_setting_id = null, $custom_field_setting_object_name = null)
    {
        list($response) = $this->findContactsByCustomFieldValueWithHttpInfo($value, $custom_field_name, $custom_field_setting_id, $custom_field_setting_object_name);
        return $response;
    }
     ...
     */
    public function findContactsByCustomFieldValueWithHttpInfo($value, $custom_field_name, $custom_field_setting_id = null, $custom_field_setting_object_name = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->findContactsByCustomFieldValueRequest($value, $custom_field_name, $custom_field_setting_id, $custom_field_setting_object_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findContactsByCustomFieldValueAsync($value, $custom_field_name, $custom_field_setting_id = null, $custom_field_setting_object_name = null)
    {
        return $this->findContactsByCustomFieldValueAsyncWithHttpInfo($value, $custom_field_name, $custom_field_setting_id, $custom_field_setting_object_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findContactsByCustomFieldValueAsyncWithHttpInfo($value, $custom_field_name, $custom_field_setting_id = null, $custom_field_setting_object_name = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->findContactsByCustomFieldValueRequest($value, $custom_field_name, $custom_field_setting_id, $custom_field_setting_object_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findContactsByCustomFieldValueRequest($value, $custom_field_name, $custom_field_setting_id = null, $custom_field_setting_object_name = null)
    {
