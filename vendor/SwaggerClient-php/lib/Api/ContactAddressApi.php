...
class ContactAddressApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelContactAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactAddressWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelContactAddressResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelContactAddressResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
