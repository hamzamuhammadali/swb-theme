...
class LayoutApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelChangeLayoutResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCreditNoteTemplateWithHttpInfo($credit_note_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelChangeLayoutResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelChangeLayoutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
