<?php
/**
 * ModelChangeLayoutResponseMetadatenThumbs
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ModelChangeLayoutResponseMetadatenThumbs Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelChangeLayoutResponseMetadatenThumbs implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_ChangeLayoutResponse_metadaten_thumbs';
    ...
    protected static $swaggerTypes = [
        'key' => 'string',
        'name' => 'string',
        'values' => '\Swagger\Client\Model\ModelChangeLayoutResponseMetadatenValues[]'
    ];
     ...
     * Gets values
     *
     * @return \Swagger\Client\Model\ModelChangeLayoutResponseMetadatenValues[]
     */
     ...
     * Sets values
     *
     * @param \Swagger\Client\Model\ModelChangeLayoutResponseMetadatenValues[] $values values
     *
     * @return $this
     */
