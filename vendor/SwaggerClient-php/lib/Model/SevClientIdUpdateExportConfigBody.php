<?php
/**
 * SevClientIdUpdateExportConfigBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SevClientIdUpdateExportConfigBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SevClientIdUpdateExportConfigBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SevClientId_updateExportConfig_body';
    ...
    protected static $swaggerFormats = [
        'accountant_number' => null,
        'accountant_client_number' => null,
        'accounting_year_begin' => 'timestamp'
    ];
    ...
    protected static $setters = [
        'accountant_number' => 'setAccountantNumber',
        'accountant_client_number' => 'setAccountantClientNumber',
        'accounting_year_begin' => 'setAccountingYearBegin'
    ];
    ...
    protected static $getters = [
        'accountant_number' => 'getAccountantNumber',
        'accountant_client_number' => 'getAccountantClientNumber',
        'accounting_year_begin' => 'getAccountingYearBegin'
    ];
    ...
    {
        $this->container['accountant_number'] = isset($data['accountant_number']) ? $data['accountant_number'] : null;
        $this->container['accountant_client_number'] = isset($data['accountant_client_number']) ? $data['accountant_client_number'] : null;
        $this->container['accounting_year_begin'] = isset($data['accounting_year_begin']) ? $data['accounting_year_begin'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountant_number'] === null) {
            $invalidProperties[] = "'accountant_number' can't be null";
        }
        if ($this->container['accountant_client_number'] === null) {
            $invalidProperties[] = "'accountant_client_number' can't be null";
        }
        if ($this->container['accounting_year_begin'] === null) {
            $invalidProperties[] = "'accounting_year_begin' can't be null";
        }
    ...
    /**
     * Gets accountant_number
     *
     * @return float
     */
    public function getAccountantNumber()
    {
        return $this->container['accountant_number'];
    }

    /**
     * Sets accountant_number
     *
     * @param float $accountant_number accountant_number
     *
     * @return $this
     */
    public function setAccountantNumber($accountant_number)
    {
        $this->container['accountant_number'] = $accountant_number;

        return $this;
    }

    /**
     * Gets accountant_client_number
     *
     * @return float
     */
    public function getAccountantClientNumber()
    {
        return $this->container['accountant_client_number'];
    }

    /**
     * Sets accountant_client_number
     *
     * @param float $accountant_client_number accountant_client_number
     *
     * @return $this
     */
    public function setAccountantClientNumber($accountant_client_number)
    {
        $this->container['accountant_client_number'] = $accountant_client_number;

        return $this;
    }

    /**
     * Gets accounting_year_begin
     *
     * @return float
     */
    public function getAccountingYearBegin()
    {
        return $this->container['accounting_year_begin'];
    }

    /**
     * Sets accounting_year_begin
     *
     * @param float $accounting_year_begin accounting_year_begin
     *
     * @return $this
     */
    public function setAccountingYearBegin($accounting_year_begin)
    {
        $this->container['accounting_year_begin'] = $accounting_year_begin;
