<?php
/**
 * ModelCreditNoteSendByWithRenderValues
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ModelCreditNoteSendByWithRenderValues Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCreditNoteSendByWithRenderValues implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_CreditNote_sendByWithRender_values';
    ...
    protected static $setters = [
        'name' => 'setName',
        'translation_cade' => 'setTranslationCade',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'name' => 'getName',
        'translation_cade' => 'getTranslationCade',
        'value' => 'getValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['translation_cade'] = isset($data['translation_cade']) ? $data['translation_cade'] : null;
    ...
    /**
     * Gets translation_cade
     *
     * @return string
     */
    public function getTranslationCade()
    {
        return $this->container['translation_cade'];
    }

    /**
     * Sets translation_cade
     *
     * @param string $translation_cade translation_cade
     *
     * @return $this
     */
    public function setTranslationCade($translation_cade)
    {
        $this->container['translation_cade'] = $translation_cade;
