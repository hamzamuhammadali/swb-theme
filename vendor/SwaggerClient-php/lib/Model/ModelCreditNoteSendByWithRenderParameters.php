<?php
/**
 * ModelCreditNoteSendByWithRenderParameters
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ModelCreditNoteSendByWithRenderParameters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCreditNoteSendByWithRenderParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_CreditNote_sendByWithRender_parameters';
    ...
    protected static $swaggerTypes = [
        'key' => 'string',
        'name' => 'string',
        'values' => '\Swagger\Client\Model\ModelCreditNoteSendByWithRenderValues[]',
        'visible' => 'bool',
        'value' => 'string'
    ];
     ...
     * Gets values
     *
     * @return \Swagger\Client\Model\ModelCreditNoteSendByWithRenderValues[]
     */
     ...
     * Sets values
     *
     * @param \Swagger\Client\Model\ModelCreditNoteSendByWithRenderValues[] $values values
     *
     * @return $this
     */
