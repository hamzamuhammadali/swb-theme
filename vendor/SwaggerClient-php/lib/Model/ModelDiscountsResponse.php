...
/**
 * ModelDiscountsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelDiscountsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_discountsResponse';
     ...
     * Sets id
     *
     * @param int $id The id of the discount
     *
     * @return $this
     */
     ...
     * Sets create
     *
     * @param string $create Date of discount creation
     *
     * @return $this
     */
     ...
     * Sets update
     *
     * @param string $update Date of last discount update
     *
     * @return $this
     */
     ...
     * Sets sev_client
     *
     * @param string $sev_client Client to which the discount belongs
     *
     * @return $this
     */
     ...
     * Sets discount
     *
     * @param string $discount Indicates that this is a discount or a surcharge (0 = surcharge, 1 = discount)
     *
     * @return $this
     */
     ...
     * Sets is_net
     *
     * @param string $is_net Defines is the Discount net or gross (0 = net, 1 = gross)
     *
     * @return $this
     */
