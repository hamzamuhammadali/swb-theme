<?php
/**
 * CreditNoteFactorycreateFromVoucherVoucher
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CreditNoteFactorycreateFromVoucherVoucher Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditNoteFactorycreateFromVoucherVoucher implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditNoteFactorycreateFromVoucher_voucher';
     ...
     * Sets id
     *
     * @param int $id The id of the existing Voucher
     *
     * @return $this
     */
     ...
     * Sets object_name
     *
     * @param string $object_name The objectName must be 'Voucher'
     *
     * @return $this
     */
