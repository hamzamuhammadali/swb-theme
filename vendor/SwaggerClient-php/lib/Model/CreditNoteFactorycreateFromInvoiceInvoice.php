<?php
/**
 * CreditNoteFactorycreateFromInvoiceInvoice
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CreditNoteFactorycreateFromInvoiceInvoice Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditNoteFactorycreateFromInvoiceInvoice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditNoteFactorycreateFromInvoice_invoice';
     ...
     * Sets id
     *
     * @param int $id The id of the existing invoice
     *
     * @return $this
     */
     ...
     * Sets object_name
     *
     * @param string $object_name The objectName must be 'Invoice'
     *
     * @return $this
     */
