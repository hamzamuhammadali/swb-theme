 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ValidationErrorError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'validationError_error';
    ...
    protected static $setters = [
        'message' => 'setMessage',
        'exception_uuid' => 'setExceptionUuid'
    ];
    ...
    protected static $getters = [
        'message' => 'getMessage',
        'exception_uuid' => 'getExceptionUuid'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['exception_uuid'] = isset($data['exception_uuid']) ? $data['exception_uuid'] : null;
    }
     ...
     * @return string
     */
    public function getExceptionUuid()
    {
        return $this->container['exception_uuid'];
    }

    /**
     * Sets exception_uuid
     *
     * @param string $exception_uuid An identifier of this exact problem that can be given to the support team.
     *
     * @return $this
     */
    public function setExceptionUuid($exception_uuid)
    {
        $this->container['exception_uuid'] = $exception_uuid;
