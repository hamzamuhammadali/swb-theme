...
class ModelChangeLayoutResponseMetadaten implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'pages' => 'int',
        'doc_id' => 'string',
        'thumbs' => '\Swagger\Client\Model\ModelChangeLayoutResponseMetadatenThumbs[]'
    ];
     ...
     * Gets thumbs
     *
     * @return \Swagger\Client\Model\ModelChangeLayoutResponseMetadatenThumbs[]
     */
     ...
     * Sets thumbs
     *
     * @param \Swagger\Client\Model\ModelChangeLayoutResponseMetadatenThumbs[] $thumbs the pdf file
     *
     * @return $this
     */
