...
class ModelInvoicePos implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'part' => '\Swagger\Client\Model\ModelCreditNotePosPart',
        'quantity' => 'float',
        'price' => 'float',
        'name' => 'string',
     ...
     * Gets part
     *
     * @return \Swagger\Client\Model\ModelCreditNotePosPart
     */
     ...
     * Sets part
     *
     * @param \Swagger\Client\Model\ModelCreditNotePosPart $part part
     *
     * @return $this
     */
