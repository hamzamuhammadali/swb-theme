...
$dotenv->load();
$sevdeskApiKey = $_ENV['SEVDMIN_API_KEY'];
...
function createSevdeskReminder( $orderID, $invoiceID ) {
	...
	$sevUserResponse = initCurl( '', 'https://my.sevdesk.de/api/v1/SevUser/755720', 'GET' );
...
function sendSevdeskReminder( $orderID ) {
	...
	initCurl( $emailData, 'https://my.sevdesk.de/api/v1/Invoice/' . $reminderID . '/sendViaEmail', CURLOPT_POST );
