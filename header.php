...
<header class="header clear" role="banner">
    <div class="container-fluid container-fluid--header">
        <nav class="navbar-expand-lg row align-items-center" role="navigation">
            <div class="col-auto mr-auto ml-md-auto ml-lg-0">
                <div class="logo">
                    <a href="<?php echo esc_url( home_url() ); ?>">
	                    <img src="https://www.swb-waerme.de/wp-content/uploads/2024/04/SWB_WAeRME.svg" alt="Logo"
                             class="logo-img"
                             width="290">
                    </a>
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="27" viewBox="0 0 44 27">
                    <path id="Pfad_136" data-name="Pfad 136"
                          d="M17.342,0H45.658A1.428,1.428,0,0,1,47,1.5,1.428,1.428,0,0,1,45.658,3H17.342A1.428,1.428,0,0,1,16,1.5,1.428,1.428,0,0,1,17.342,0Z"
                          transform="translate(-16)" fill="#222"/>
                    <rect id="Rechteck_42" data-name="Rechteck 42" width="44" height="3" rx="1.5"
                          transform="translate(0 12)"
                          fill="#222"/>
                    <rect id="Rechteck_42-2" data-name="Rechteck 42" width="44" height="3" rx="1.5"
            ...
            <div class="col-12 col-lg-auto">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav justify-content-end">
						<?php
						global $post;
						$thePostID = $post->ID ?? null;

						$getMenu = wp_get_nav_menu_items( 'menu' ); // Where menu1 can be ID, slug or title

						foreach ( $getMenu as $item ) {
							echo '<li class="nav-item' . ( $thePostID == $item->object_id ? ' active' : '' ) . '"><a class="nav-link" href="' . $item->url . '">' . $item->title . '</a></li>';
						}
						?>
                    </ul>
                </div>
